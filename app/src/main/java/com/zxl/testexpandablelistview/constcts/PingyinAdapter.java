...
public abstract class PingyinAdapter<T> extends BaseExpandableListAdapter {
    ...
    private int layoutChildId, layoutGroupId, groupIdTitleId;
    private PinyinKeyMapList<T> keyMapList;
    private LayoutInflater inflater;


    public PingyinAdapter(ExpandableListView listView, List<T> list, int layoutGroupId, int groupIdTitleId, int layoutChildId) {
        this.context = listView.getContext();
        this.listView = listView;
        this.layoutChildId = layoutChildId;
        this.layoutGroupId = layoutGroupId;
        this.groupIdTitleId = groupIdTitleId;
    ...
    public View getGroupView(int group, boolean arg1, View contentView,
                             ViewGroup arg3) {
        if (contentView == null) {
            contentView = inflater.inflate(layoutGroupId, null);
            contentView.setClickable(true);
        }
        TextView textView = (TextView) contentView.findViewById(groupIdTitleId);
